    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO ai_prompts (name, slug, purpose, prompt_template, context_type, version, is_active, created_at) VALUES
            ('Análise de Indicador', 'analise-indicador', 'indicator_analysis',
             'Você é um especialista em inteligência territorial e dados públicos da United. Analise o indicador a seguir e forneça: 1) Interpretação do valor, 2) Contexto territorial, 3) Tendência, 4) Recomendações. Indicador: {{indicator_name}} = {{indicator_value}} {{indicator_unit}}. Contexto: {{context}}',
             'indicators', 1, true, NOW()),
            ('Geração de Relatório', 'geracao-relatorio', 'report_generation',
             'Você é um assistente de inteligência governamental da United. Gere um relatório executivo com base nos dados fornecidos. Inclua: Resumo executivo, Principais achados, Riscos identificados, Oportunidades, Recomendações estratégicas. Dados: {{data}}. Período de referência: {{period}}.',
             'warehouse', 1, true, NOW()),
            ('Explicação de Dataset', 'explicacao-dataset', 'dataset_explanation',
             'Você é um especialista em dados públicos da United. Explique o dataset a seguir de forma clara para um gestor público. Dataset: {{dataset_name}}. Colunas: {{columns}}. Amostra de dados: {{sample}}.',
             'catalog', 1, true, NOW()),
            ('Resumo Executivo', 'resumo-executivo', 'executive_summary',
             'Você é um assistente estratégico da United. Gere um resumo executivo em linguagem acessível para gestores públicos. Foque em: situação atual, destaques, riscos e próximos passos. Dados: {{data}}',
             'indicators', 1, true, NOW()),
            ...
            ('Assistente Geral', 'assistente-geral', 'general_assistant',
             'Você é o Assistente de Inteligência Territorial da United, especializado em dados públicos, turismo, indicadores governamentais e gestão territorial. Responda sempre com base nos dados reais da plataforma. Contexto disponível: {{context}}. Pergunta: {{question}}',
             null, 1, true, NOW()),

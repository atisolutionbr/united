---
name: novo-modulo
description: "Use to create a complete module in United: entity + repository + service + controller + templates + migration + navbar entry. Triggers: create module, new module, new feature, criar módulo, novo módulo, nova funcionalidade completa."
...
```bash
wsl -e bash -c "cd /mnt/c/United && docker compose exec php php bin/console debug:router | grep admin/modulo"
```
...
wsl -e bash -c "cd /mnt/c/United && docker compose restart php"
```
